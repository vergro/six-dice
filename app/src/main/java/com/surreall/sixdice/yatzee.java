...
public class yatzee extends Main{   
	...
	ResizableButton[] upButtons = new ResizableButton[9];
	ResizableButton[] upButtons2 = new ResizableButton[9]; 
	ResizableButton[] loButtons = new ResizableButton[12]; 
	ResizableButton[] loButtons2 = new ResizableButton[12];
	ResizableButton grandButton;
	ResizableButton submitScore;
	ResizableButton rollit;
	
	String[] achString = new String[40];
	String[] achMessage = new String[40];
	ResizableButton[] upText = new ResizableButton[9];
	ResizableButton[] loText = new ResizableButton[12];
	TextView grandText, overT,gameT, startT;
	TextView twoPair;
	
	ResizableButton hiScore, hiScoreText;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        hiScore = (ResizableButton)findViewById(R.id.gameHiScore);
        hiScoreText = (ResizableButton)findViewById(R.id.gameHiScoreText);
        ...
        rollit = (ResizableButton)findViewById(R.id.roll);
        rollit.setText("Roll");
        grandButton = (ResizableButton)findViewById(R.id.GrandTotal);
	    ...
	    for(int i=0; i<upText.length;i++){
	        upText[i] = (ResizableButton)findViewById(upTextIds[i]);
	    }
        for(int i = 0; i<6; i++){
        ...
        for(int i = 0; i<9; i++){
        	upButtons[i] = (ResizableButton)findViewById(upIds[i]);
        	upButtons2[i] = (ResizableButton)findViewById(upIds2[i]);
        }
        for(int i=0; i<loText.length;i++){
        	loText[i] = (ResizableButton)findViewById(loTextIds[i]);
        }
        
        for(int i = 0; i<12; i++){
        	loButtons[i] = (ResizableButton)findViewById(loIds[i]);
...
//					}
	...
	private void textAdjust() {
		...
		if(layHi <400){    
			ats1 = 11; ats2 = 11; ms1 = 0; ms2 = 2; ms3 = 3; ms4 = 5; ht1 = 9;		// QVGA
		}
		if(layHi >=400 & layHi <480){
			ats1 = 11; ats2 = 12; ms1 = 0; ms2 = 2; ms3 = 3; ms4 = 3; ht1 = 9;
		}
		if(layHi >=480 &layHi < 800 ){
			ats1 = 12; ats2 = 12; ms1 = 0; ms2 = 2; ms3 = 4; ms4 = 9; ht1 = 9;    	// HVGA
		}
		if(layHi >=800 & layHi < 900){
			ats1 = 12; ats2 = 14; ms1 = 2; ms2 = 4; ms3 = 2; ms4 = 5; ht1 = 10;
		}
		if(layHi >=900 & layHi < 1000){
			ats1 = 14; ats2 = 17; ms1 = 4; ms2 = 5;  ms3 = 3; ms4 = 4; ht1 = 11;
		}
		if(layHi >=1000 & layHi < 1100){
			ats1 = 16; ats2 = 20; ms1 = 25; ms2 = 6; ms3 = 6; ms4 = 4; ht1 = 12;
		}
		if(layHi >=1100 & layHi < 1200){ 
			ats1 = 18; ats2 = 22; ms1 = 26; ms2 = 8; ms3 =8; ms4 = 4; ht1 = 13;
		}
		if(layHi >=1200 & layHi < 1300){ 
			ats1 = 22; ats2 = 32; ms1 = 26; ms2 = 10; ms3 = 8; ms4 = 4; ht1 = 14;
		}
		if(layHi >=1300){
			ats1 = 24;	ats2 = 34; ms1 = 26; ms2 = 12; ms3 = 10; ms4 = 4; ht1 = 15;
		}
		...
		if(layHi >= 970){ //TODO
			...
			params3 = (LinearLayout.LayoutParams)diceMenu.getLayoutParams();
			params3.weight = (float) 0.55;
			diceMenu.setLayoutParams(params3);
			params3 = (LinearLayout.LayoutParams)rollMenu.getLayoutParams();
...
//    	}    	
	...
	public void resetGame() {
		...
		highScore = mGameSettings.getInt(GAME_PREFERENCES_HISCORE, 0);
		hiScoreText();
		hiScore.setTextColor(Color.BLACK);
